...
module.exports = {
    ...
    UNISWAP_V3_POOL_ADDRESSES_ADDRESS: process.env.UNISWAP_V3_POOL_ADDRESSES_ADDRESS,
    ...
    UNISWAP_V3_FACTORY_EVENT_POOL_CREATED: ["event PoolCreated(address indexed token0, address indexed token1, uint24 indexed fee, int24 tickSpacing, address pool)"], 
    UNISWAP_V3_POOL_ABI: {
        abi
      } = require('@uniswap/v3-core/artifacts/contracts/UniswapV3Pool.sol/UniswapV3Pool.json').abi,
    UNISWAP_V3_POOL_ADDRESSES_ABI: require('../abi/UniswapV3LPAddresses.json').abi,
    ...
    UNISWAP_V3_NFT_POSITION_MANAGER_ABI: { abi } = require("@uniswap/v3-periphery/artifacts/contracts/NonfungiblePositionManager.sol/NonfungiblePositionManager.json").abi,
    UNISWAP_V3_NFT_POSITION_MANAGER_ADDRESS: process.env.UNISWAP_V3_NFT_POSITION_MANAGER_ADDRESS,
